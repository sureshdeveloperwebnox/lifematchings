...
Route::group(['namespace' => 'Api', 'middleware' => ['app_language']], function () {
    ...
    Route::get('/sun-signs', 'ProfileDropdownController@sun_sign_list');
    Route::get('/moon-signs', 'ProfileDropdownController@moon_sign_list');
    Route::get('/moon-signs/{id}', 'ProfileDropdownController@moon_signs_by_sun_sign');
