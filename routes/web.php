...
|
*/
Route::post('getAstrologyReport', [ProfileController::class, 'getAstrologyReport']);

Route::get('/testotp', [StateController::class, 'testotp']);
Route::get('/cities', [StateController::class, 'fetchCities']);
Route::get('/indian-cities', [StateController::class, 'getIndianCities']);
Route::get('/get-moon-signs/{sun_sign_id}', [App\Http\Controllers\SunSignController::class, 'getMoonSignsBySunSign'])->name('get.moon.signs');
Route::get('uploadAstrologyReport/{id}', [MemberController::class, 'uploadAstrologyReport'])->name('uploadAstrologyReport');
Route::post('storeAstrologyReport', [MemberController::class, 'storeAstrologyReport'])->name('storeAstrologyReport');
Route::get('testtr-page', function() { return view('test_tamil_button'); })->name('testtr.page');
Route::get('testtr', [MemberController::class, 'testtr'])->name('testtr');
Route::get('testtr2', [App\Http\Controllers\TamilPdfTestController::class, 'generateTamilPdf'])->name('testtr2');
Route::get('testtr3', [App\Http\Controllers\TamilPdfTest3Controller::class, 'generateTamilPdf'])->name('testtr3');
...
Route::get('/initial-payment-methods', [InitialPaymentController::class, 'payment_methods'])->name('initial.payment.methods');
    Route::controller(InitialPaymentController::class)->group(function () {
        Route::post('/initial-payment', 'store')->name('initial.payment.store');
        Route::post('/initial-payment-razorpay', 'payWithRazorpay')->name('initial.payment.razorpay');
        Route::post('/initial-payment-paypal', 'payWithPaypal')->name('initial.payment.paypal');
        Route::post('/initial-payment-done', 'payment_done_api')->name('initial.payment.done');
    });
...
Route::group(['middleware' => ['member', 'verified']], function () {
    ...
    Route::controller(MemberController::class)->group(function () {
        ...
        Route::get('/profile-settings', 'profile_settings')->name('profile_settings')->middleware('checkPayment');
    ...
    Route::controller(ExpressInterestController::class)->group(function () {
        Route::get('/my-interests', 'index')->name('my_interests.index')->middleware('checkPayment');
        Route::get('/interest/requests', 'interest_requests')->name('interest_requests')->middleware('checkPayment');
    ...
    Route::controller(ChatController::class)->group(function () {
        Route::get('/chat', 'index')->name('all.messages')->middleware('checkPayment');
        Route::get('/single-chat/{id}', 'chat_view')->name('chat_view')->middleware('checkPayment');
        Route::post('/chat-reply', 'chat_reply')->name('chat.reply');
        Route::get('/chat/refresh/{id}', 'chat_refresh')->name('chat_refresh')->middleware('checkPayment');
    ...
    Route::controller(ShortlistController::class)->group(function () {
        Route::get('/my-shortlists', 'index')->name('my_shortlists')->middleware('checkPayment');
    ...
    Route::controller(IgnoredUserController::class)->group(function () {
        Route::get('/ignored-list', 'index')->name('my_ignored_list')->middleware('checkPayment');
    ...
    Route::controller(WalletController::class)->group(function () {
        Route::get('/wallet', 'index')->name('wallet.index')->middleware('checkPayment');
        Route::get('/wallet-recharge-methods', 'wallet_recharge_methods')->name('wallet.recharge_methods')->middleware('checkPayment');
    ...
    Route::resource('profile-viewers', ProfileViewerController::class)->middleware('checkPayment');
    Route::get('/matched-profiles',[ProfileMatchController::class, 'myMatchedProfiles'])->name('my_matched_profiles')->middleware('checkPayment');
});
