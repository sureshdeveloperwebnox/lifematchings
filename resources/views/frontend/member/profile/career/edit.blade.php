<form action="{{ route('career.update', $career->id) }}" method="POST">
    ...
    <div class="modal-body">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input type="text" name="annual_income" value="{{$career->annual_income}}" placeholder="{{translate('Annual Income')}}" class="form-control" required>
            </div>
        </div>
        <div class="form-group row">
            <label class="col-md-3 col-form-label">{{translate('Additional Income')}}</label>
            <div class="col-md-9">
                <input type="text" name="additional_income" value="{{$career->additional_income}}" placeholder="{{translate('Additional Income')}}" class="form-control" required>
            </div>
        </div>
        {{-- <div class="form-group row">
