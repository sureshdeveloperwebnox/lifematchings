                                                ...
                                                <div class="row no-gutters">
                                                    <div class="col-md-6">
                                                        <table class="w-100">
                                                            <tbody>
                                                                <tr>
                                                                    <th class="py-1">{{ translate('Rasi/Zodiac Sign') }}
                                                                    </th>
                                                                    <td class="py-1">
                                                                        @php
                                                                            $sun_sign_display = '';
                                                                            if($user->astrologies && $user->astrologies->sun_sign) {
                                                                                // Check if it's numeric (ID) or string (name)
                                                                                if(is_numeric($user->astrologies->sun_sign)) {
                                                                                    $sun_sign_obj = \App\Models\SunSign::find($user->astrologies->sun_sign);
                                                                                    $sun_sign_display = $sun_sign_obj ? $sun_sign_obj->name : '';
                                                                                } else {
                                                                                    // If it's already a name, use it directly
                                                                                    $sun_sign_display = $user->astrologies->sun_sign;
                                                                                }
                                                                            }
                                                                        @endphp
                                                                        {{ $sun_sign_display }}
                                                    ...
                                                    <div class="col-sm-6 border-sm-left ">
                                                        <table class="w-100 ml-sm-4">
                                                            <tbody>
                                                                <tr>
                                                                    <th class="py-1">{{ translate('Star/Nakshatra') }}
                                                                    </th>
                                                                    <td class="py-1">
                                                                        @php
                                                                            $moon_sign_display = '';
                                                                            if($user->astrologies && $user->astrologies->moon_sign) {
                                                                                // Check if it's numeric (ID) or string (name)
                                                                                if(is_numeric($user->astrologies->moon_sign)) {
                                                                                    $moon_sign_obj = \App\Models\MoonSign::find($user->astrologies->moon_sign);
                                                                                    $moon_sign_display = $moon_sign_obj ? $moon_sign_obj->name : '';
                                                                                } else {
                                                                                    // If it's already a name, use it directly
                                                                                    $moon_sign_display = $user->astrologies->moon_sign;
                                                                                }
                                                                            }
                                                                        @endphp
                                                                        {{ $moon_sign_display }}
                                                                ...
                                                                <tr>
                                                                    <th class="py-1">{{ translate('Lagnam/Lagna') }}
                                                                    </th>
                                                                    <td class="py-1">
                                                                        @php
                                                                            $lagnam_display = '';
                                                                            if($user->astrologies && $user->astrologies->lagnam) {
                                                                                // Check if it's numeric (ID) or string (name)
                                                                                if(is_numeric($user->astrologies->lagnam)) {
                                                                                    $lagnam_obj = \App\Models\SunSign::find($user->astrologies->lagnam);
                                                                                    $lagnam_display = $lagnam_obj ? $lagnam_obj->name : '';
                                                                                } else {
                                                                                    // If it's already a name, use it directly
                                                                                    $lagnam_display = $user->astrologies->lagnam;
                                                                                }
                                                                            }
                                                                        @endphp
                                                                        {{ $lagnam_display }}
