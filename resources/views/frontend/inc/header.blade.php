                    ...
                    <ul class="list-inline mb-0 d-flex align-items-center justify-content-end text-nowrap">
                        ...
                        <li class="list-inline-item d-flex align-items-center">
                            <a href="{{ route('profile_settings') }}"
                                class="btn btn-sm button text-white fw-600 py-1 border">{{translate('My Profile')}}</a>
                        </li>
                        @else
                        <li class="list-inline-item ml-4">
                            <a class="btn btn-sm button text-white fw-600 py-1 border" href="{{ route('login') }}">{{ translate('Log In') }}</a>
                        </li>
        ...
        <div class="aiz-navbar position-relative bg-color">
            ...
            <div class="d-lg-flex justify-content-center text-center text-lg-left w-100">
                <ul class="my-3 pl-10 d-lg-flex align-items-center justify-content-center w-100 ">
                    <li class="d-inline-block d-lg-flex pb-1 flex-grow-1 text-center {{ areActiveRoutes(['home'],) }}">
                    ...
                    <li class="d-inline-block d-lg-flex pb-1 flex-grow-1 text-center">
                        <a class="nav-link text-uppercase fw-700 fs-15 d-flex align-items-center justify-content-center py-2"
                            href="{{ route('about.us') }}">
                            <span class="text-white mb-n1">{{ translate('About Us') }}</span>
                        </a>
                    </li>

                    <li class="d-inline-block d-lg-flex pb-1 flex-grow-1 text-center {{ areActiveRoutes(['member.listing'],'bg-primary-grad') }}">
                        <a class="nav-link text-uppercase fw-700 fs-15 d-flex align-items-center justify-content-center py-2"
                            href="{{ route('member.listing') }}">
                            <span class="text-white mb-n1">{{ translate('Service') }}</span>
                        </a>
                    </li>
                    <li class="d-inline-block d-lg-flex pb-1 flex-grow-1 text-center {{ areActiveRoutes(['packages'],'bg-primary-grad') }}">
                        <a class="nav-link text-uppercase fw-700 fs-15 d-flex align-items-center justify-content-center py-2"
                            href="{{ route('packages') }}">
                            <span class="text-white mb-n1">{{ translate('Packages') }}</span>
                        </a>
                    </li>
                    <li class="d-inline-block d-lg-flex pb-1 flex-grow-1 text-center {{ areActiveRoutes(['happy_stories'],'bg-primary-grad') }}">
                        <a class="nav-link text-uppercase fw-700 fs-15 d-flex align-items-center justify-content-center py-2"
                            href="{{ route('happy_stories') }}">
                            <span class="text-white mb-n1">{{ translate('Membership Plan') }}</span>
                        </a>
                    </li>
                    <li class="d-inline-block d-lg-flex pb-1 flex-grow-1 text-center {{ areActiveRoutes(['contact_us'],'bg-primary-grad') }}">
                        <a class="nav-link text-uppercase fw-700 fs-15 d-flex align-items-center justify-content-center py-2"
                            href="{{ route('contact_us') }}">
                            <span class="text-white mb-n1">{{ translate('Contact') }}</span>
                        </a>
                    </li>
                    <li class="d-inline-block d-lg-flex pb-1 flex-grow-1 text-center {{ areActiveRoutes(['contact_us'],'bg-primary-grad') }}">
                        <a class="nav-link text-uppercase fw-700 fs-15 d-flex align-items-center justify-content-center py-2"
                            href="{{ route('contact_us') }}">
                            <span class="text-white mb-n1">{{ translate('Success Stories') }}</span>
                        </a>
                    </li>
                </ul>
            </div>
    ...
    <div class="container">
      ...
      <div class="d-flex d-lg-none justify-content-between align-items-center w-100">
        ...
        <div class="d-flex align-items-center gap-2">
          ...
          @guest
            ...
            <a class="btn btn-sm custom-login-btn fw-600 px-2 py-1" href="{{ route('login') }}">
              {{ translate('Log In') }}
            </a>
          @endguest
          ...
          @auth
            <!-- Show when logged in -->
            <a class="btn btn-sm button text-white fw-600 px-2 py-1" href="{{ route('dashboard') }}">
              {{ translate('Dashboard') }}
            </a>
            <div class="col">
                    <a href="javascript:void(0)" class="text-reset d-block flex-grow-1 text-center py-2 mobile-side-nav-thumb" data-toggle="class-toggle" data-target=".aiz-mobile-side-nav">
                        <span class="d-block mx-auto mb-1 opacity-100">
                            <img src="{{ uploaded_asset(Auth::user()->photo)}}" class="rounded-circle size-30px" onerror="this.onerror=null;this.src='{{ static_asset('assets/img/avatar-place.png') }}';">
                        </span>
                    </a>
                </div>
          @endauth
      ...
      <div class="collapse navbar-collapse justify-content-center text-center text-lg-left w-100 mt-3 mt-lg-0" id="navbarNav">
        <ul class="navbar-nav w-100 d-lg-flex align-items-center justify-content-end gap-4">
          <li class="nav-item"><a class="nav-link text-white text-uppercase fw-700 fs-15 py-2" href="{{ route('home') }}">{{ translate('Home') }}</a></li>
          <li class="nav-item"><a class="nav-link text-white text-uppercase fw-700 fs-15 py-2" href="{{ route('about.us') }}">{{ translate('About Us') }}</a></li>
          <li class="nav-item"><a class="nav-link text-white text-uppercase fw-700 fs-15 py-2" href="{{ route('service') }}">{{ translate('Services') }}</a></li>
          <li class="nav-item"><a class="nav-link text-white text-uppercase fw-700 fs-15 py-2" href="{{ route('member.listing') }}">{{ translate('Active Members') }}</a></li>
          <li class="nav-item"><a class="nav-link text-white text-uppercase fw-700 fs-15 py-2" href="{{ route('packages') }}">{{ translate('Packages') }}</a></li>
          <li class="nav-item"><a class="nav-link text-white text-uppercase fw-700 fs-15 py-2" href="{{ route('happy_stories') }}">{{ translate('Success Stories') }}</a></li>
          <li class="nav-item"><a class="nav-link text-white text-uppercase fw-700 fs-15 py-2" href="{{ route('contact_us') }}">{{ translate('Contact us') }}</a></li>
          <li class="nav-item"><a class="nav-link text-white sm-display-block d-lg-none text-uppercase fw-700 fs-15 py-2" href="{{ route('logout') }}">{{ translate('Logout') }}</a></li>
          @auth
