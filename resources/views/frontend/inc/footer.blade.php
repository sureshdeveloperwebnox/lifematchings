        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-4">
                <div class="footer-logo mb-3">
                    <a href="{{ route('home') }}">
                        @if(get_setting('footer_logo') != null)
                            <img src="/public/assets/img/Logo-04.png" alt="{{ env('APP_NAME') }}" class="mw-100" height="40">
                        @else
                            <img src="/public/assets/img/Logo-04.png" alt="{{ env('APP_NAME') }}" class="mw-100" height="40">
                        @endif
                    </a>
            ...
            <div class="col-md-8">
                <div class="row" > 
                    ...
                    <div class="col-md-4 s-align">
                        <h5 class="footer-title">{{ get_setting('widget_one_title') }}</h5>
                        <ul class="list-unstyled">
                            @foreach (json_decode( get_setting('widget_one_labels'), true) as $key => $value)
                                <li><a href="{{ json_decode( get_setting('widget_one_links'), true)[$key] }}" class="footer-link">{{ $value }}</a></li>
                            @endforeach
                        </ul>
                    </div>
                    @endif
                    ...
                    @if ( !empty(get_setting('widget_two_labels')) )
                    <div class="col-md-4 s-align">
                        <h5 class="footer-title">{{ get_setting('widget_two_title') }}</h5>
                        <ul class="list-unstyled">
                            @foreach (json_decode( get_setting('widget_two_labels'), true) as $key => $value)
                                <li><a href="{{ json_decode( get_setting('widget_two_links'), true)[$key] }}" class="footer-link">{{ $value }}</a></li>
                            @endforeach
                        </ul>
                    </div>
                    @endif
                    ...
                    @if ( !empty(get_setting('widget_three_labels')) )
                    <div class="col-md-4 s-align">
                        <h5 class="footer-title">{{ get_setting('widget_three_title') }}</h5>
                        <ul class="list-unstyled">
                            @foreach (json_decode( get_setting('widget_three_labels'), true) as $key => $value)
                                <li><a href="{{ json_decode( get_setting('widget_three_links'), true)[$key] }}" class="footer-link">{{ $value }}</a></li>
                            @endforeach
                        </ul>
                    </div>
                    @endif
