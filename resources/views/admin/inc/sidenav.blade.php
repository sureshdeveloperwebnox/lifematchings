                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            ...
                            <ul class="aiz-side-nav-list level-3">
                                ...
                                @can('show_sun_signs')
                                    <li class="aiz-side-nav-item">
                                        <a href="{{ route('sun-signs.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['sun-signs.edit']) }}">
                                            <span class="aiz-side-nav-text">{{ translate('Rasi/Zodiac Signs') }}</span>
                                        </a>
                                    </li>
                                @endcan
                                @can('show_moon_signs')
                                    <li class="aiz-side-nav-item">
                                        <a href="{{ route('moon-signs.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['moon-signs.edit']) }}">
                                            <span class="aiz-side-nav-text">{{ translate('Star/Nakshatras
                                            ') }}</span>
                                        </a>
                                    </li>
                                @endcan
