                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="col-sm-6">
                                ...
                                @elseif($payment->package_id == 0 && $payment->payment_method == "razorpay")
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        ...
                                                        @if ($payment->package_id == 0)
                                                            {{ $payment->custom_payment_name ?? 'Initial Payment Package' }}
                                                        @elseif ($payment->package != null)
                    ...
                    <div class="col-sm-12">
                        <div class="text-center mt-5 mb-3">
                            <button type="button" class="btn btn-primary btn-sm" onclick="printDiv('printableArea')"><i
                                    class="las la-print"></i> <?= translate('Print') ?></button>
                        </div>
                    </div>
                </div>
            </div>
