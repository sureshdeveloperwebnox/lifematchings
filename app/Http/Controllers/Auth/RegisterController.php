    ...
    */
    ...
    protected function validator(array $data)
    {
        ...
        [
            ...
            'timeOfBirth.required' => translate('Time Of Birth is required'),
            'birthPlace.required' => translate('Birth Place is required'),
            ...
            'otp.size' => translate('OTP must be 6 digits'),
    ...
    protected function create(array $data)
    {
        ...
        $astrologies->user_id       = $user->id;
        $astrologies->time_of_birth = $data['timeOfBirth'];
