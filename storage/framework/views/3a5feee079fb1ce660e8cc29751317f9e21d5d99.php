...
<?php $__env->startSection('panel_content'); ?>
    ...
    ?>
    <div class="row gutters-5 mt-4 row-cols-xl-<?php echo e($col); ?> row-cols-2">
        <div class="col mx-auto mb-3" >
            <div class="bg-light rounded overflow-hidden text-center p-3">
                <i class="la la-heart-o la-2x mb-3 text-primary-grad"></i>
                <div class="h4 fw-700 text-primary-grad"><?php echo e(get_remaining_package_value($user->id,'remaining_interest')); ?></div>
                <div class="opacity-50"><?php echo e(translate('Remaining')); ?> <br> <?php echo e(translate('Interest')); ?></div>
            </div>
        </div>
        <div class="col mx-auto mb-3" >
            <div class="bg-light rounded overflow-hidden text-center p-3">
                <i class="las la-phone la-2x mb-3 text-primary-grad"></i>
                <div class="h4 fw-700 text-primary-grad"><?php echo e(get_remaining_package_value($user->id,'remaining_contact_view')); ?></div>
                <div class="opacity-50 "><?php echo e(translate('Remaining')); ?> <br> <?php echo e(translate('Contact View')); ?></div>
            </div>
        </div>
        <div class="col mx-auto mb-3" >
            <div class="bg-light rounded overflow-hidden text-center p-3">
                <i class="las la-phone la-2x mb-3 text-primary-grad"></i>
                <div class="h4 fw-700 text-primary-grad"><?php echo e(get_remaining_package_value($user->id,'remaining_profile_viewer_view')); ?></div>
                <div class="opacity-50 "><?php echo e(translate('Remaining')); ?> <br> <?php echo e(translate('Profile Viewer View')); ?></div>
            </div>
        </div>
        <div class="col mx-auto mb-3" >
            <div class="bg-light rounded overflow-hidden text-center p-3">
                <i class="las la-image la-2x mb-3 text-primary-grad"></i>
                <div class="h4 fw-700 text-center text-primary-grad"><?php echo e(get_remaining_package_value($user->id,'remaining_photo_gallery')); ?></div>
                <div class="opacity-50 text-center"><?php echo e(translate('Remaining')); ?> <br> <?php echo e(translate('Gallery Image Upload')); ?></div>
            </div>
        </div>
        ...
        <div class="col mx-auto mb-3" >
            <div class="bg-light rounded overflow-hidden text-center p-3">
                ...
                <div class="h4 fw-700 text-primary-grad"><?php echo e(get_remaining_package_value($user->id,'remaining_profile_image_view')); ?></div>
                <div class="opacity-50 "><?php echo e(translate('Remaining')); ?> <br> <?php echo e(translate('Profile Picture View')); ?></div>
            </div>
        </div>
        <?php endif; ?>
        ...
        <div class="col mx-auto mb-3" >
            <div class="bg-light rounded overflow-hidden text-center p-3">
                ...
                <div class="h4 fw-700 text-center text-primary-grad"><?php echo e(get_remaining_package_value($user->id,'remaining_gallery_image_view')); ?></div>
                <div class="opacity-50 text-center"><?php echo e(translate('Remaining')); ?> <br> <?php echo e(translate('Gallery Images View')); ?></div>
            </div>
        </div>
        <?php endif; ?>
    </div>
                ...
                <div class="card mb-0 p-5 h-20 d-flex align-items-center justify-content-center mb-2">
                    <?php if($user->approved == 0): ?>
                        <div class="my-n4 py-1 text-center">
                            ...
                            <img style="margin-left: 120px;" src="<?php echo e(static_asset('assets/img/non_verified.png')); ?>" alt=""
                                class="w-xxl-130px w-90px d-block">
                            <a href="<?php echo e(route('member.verification')); ?>"
                                class="btn btn-sm btn-primary"><?php echo e(translate('Verify Now')); ?></a>
                        </div>
                    <?php else: ?>
                        <div class="my-2 py-1">
                            <img style="width: 400px; text-center" src="<?php echo e(static_asset('assets/img/verified-green-button-with-icon-transparent-template-sticker.png')); ?>" alt="" width="">
                        </div>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
                ...
                <div class="card-body">
                    ...
                    <div>
                        <?php $__empty_1 = true; $__currentLoopData = $similar_profiles->shuffle()->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $similar_profile): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                          <?php if($similar_profile->user != null): ?>
                            <a href="<?php echo e(route('member_profile', $similar_profile->match_id)); ?>" class="text-reset border rounded row no-gutters align-items-center mb-3">
                                <div class="col-auto w-100px">
                                  ...
                                  <img
                                      ...
                                      src="<?php echo e(uploaded_asset($similar_profile->user->photo)); ?>"
                                      <?php else: ?>
                                ...
                                <div class="col">
                                  <div class="p-3">
                                      <h5 class="fs-16 text-body text-truncate"><?php echo e($similar_profile->user->first_name.' '.$similar_profile->user->last_name); ?></h5>
                                      <div class="fs-12 text-truncate-3">
                                          <span class="mr-1 d-inline-block">
                                            <?php if(!empty($similar_profile->user->member->birthday)): ?>
                                              <?php echo e(\Carbon\Carbon::parse($similar_profile->user->member->birthday)->age); ?> <?php echo e(translate('yrs')); ?>,
                                            <?php endif; ?>
                                          </span>
                                          <span class="mr-1 d-inline-block">
                                            <?php if(!empty($similar_profile->user->physical_attributes->height)): ?>
                                              <?php echo e($similar_profile->user->physical_attributes->height); ?> <?php echo e(translate('Feet')); ?>,
                                            <?php endif; ?>
                                          </span>
                                          <span class="mr-1 d-inline-block">
                                            <?php if(!empty($similar_profile->user->member->marital_status->name)): ?>
                                              <?php echo e($similar_profile->user->member->marital_status->name); ?>,
                                            <?php endif; ?>
                                          </span>
                                          <span class="mr-1 d-inline-block">
                                            <?php echo e(!empty($similar_profile->user->spiritual_backgrounds->religion->name) ? $similar_profile->user->spiritual_backgrounds->religion->name.', ' : ""); ?>

                                          </span>
                                          <span class="mr-1 d-inline-block">
                                            <?php echo e(!empty($similar_profile->user->spiritual_backgrounds->caste->name) ? $similar_profile->user->spiritual_backgrounds->caste->name.', ' : ""); ?>

                                          </span>
                                          <span class="mr-1 d-inline-block">
                                            <td class="py-1"><?php echo e(!empty($similar_profile->user->spiritual_backgrounds->sub_caste->name) ? $similar_profile->user->spiritual_backgrounds->sub_caste->name : ""); ?></td>
                                          </span>
                                      </div>
                                  </div>
                                </div>
...
<div class="reportContent">
  <?php if($report): ?>
    <div class="report-header">
      ...
      <div class="report-subtitle">Prepared exclusively for <?php echo e($member->first_name ?? ''); ?></div>
    </div>
    ...
    <div class="info-section">
      ...
      <div class="info-grid">
        <div class="info-item">
          ...
          <div class="info-value"><?php echo e($member->first_name ?? ''); ?></div>
        </div>
        <div class="info-item">
          <div class="info-label">Birth Star/Nakshatra</div>
          <div class="info-value"><?php echo e($report->birth_star ?? ''); ?></div>
        </div>
        <div class="info-item">
          <div class="info-label">Life Matchings ID</div>
          <div class="info-value"><?php echo e($report->life_id ?? ($member->code ?? '')); ?></div>
        </div>
        <div class="info-item">
          <div class="info-label">Birth Rasi/Zodiac Sign</div>
          <div class="info-value"><?php echo e($report->birth_rasi ?? ''); ?></div>
        </div>
        <div class="info-item">
          <div class="info-label">Email</div>
          <div class="info-value"><?php echo e($member->email ?? ''); ?></div>
        </div>
        <div class="info-item">
          <div class="info-label">Birth Lagnam/Lagna</div>
          <div class="info-value"><?php echo e($report->birth_lagnam ?? ''); ?></div>
        </div>
        <div class="info-item">
          <div class="info-label">Birth Date</div>
          <div class="info-value">
            <?php if(!empty($member->member->birthday)): ?> 
              <?php echo e(date('d-m-Y', strtotime($member->member->birthday))); ?> 
            <?php else: ?>
        ...
        <div class="info-item">
          ...
          <div class="info-value"><?php echo e($report->dasa_bukthi ?? ''); ?></div>
        </div>
        <div class="info-item">
          <div class="info-label">Birth Time</div>
          <div class="info-value"><?php echo e($member->astrologies->time_of_birth ?? ""); ?></div>
        </div>
        <div class="info-item">
          <div class="info-label">Dosham</div>
          <div class="info-value"><?php echo e($report->dosham ?? ''); ?></div>
        </div>
        <div class="info-item">
          <div class="info-label">Birth Place</div>
          <div class="info-value"><?php echo e($member->astrologies->city_of_birth ?? ''); ?></div>
        </div>
        <div class="info-item">
          <div class="info-label">Parigaram</div>
          <div class="info-value"><?php echo e($report->parigaram ?? ''); ?></div>
        </div>
      </div>
    </div>
        ...
        <div class="col-md-6">
          ...
          <div class="chart-wrapper">
            <div class="chart-grid">
              ...
              <?php for($i = 0; $i < 12; $i++): ?>
                <?php if($i < 5): ?>
                  <div class="chart-box"><span class="chart-value"><?php echo e(str_replace(',', "\n", $rasiValues[$i] ?? '')); ?></span></div>
                <?php elseif($i == 5): ?>
    ...
    <div class="info-section recommenations">
      ...
      <div class="info-grid"></div>
        <div class="info-item">
          ...
          <div class="info-value"><?php echo e($report->rec_stars ?? ''); ?></div>
        </div>
        <div class="info-item">
          <div class="info-label">Recommended Rasi/Zodiac Signs</div>
          <div class="info-value"><?php echo e($report->rec_rasi ?? ''); ?></div>
        </div>
        <div class="info-item">
          <div class="info-label">Recommended Lagnam/Lagna</div>
          <div class="info-value"><?php echo e($report->rec_lagnams ?? ''); ?></div>
        </div>
        <div class="info-item">
          <div class="info-label">Dosham</div>
          <div class="info-value"><?php echo e($report->rec_dosham ?? ''); ?></div>
        </div>
        <div class="info-item">
          <div class="info-label">Direction of the Bride/Groom</div>
          <div class="info-value"><?php echo e($report->direction ?? ''); ?></div>
        </div>
        <div class="info-item">
          <div class="info-label">Local or Abroad</div>
          <div class="info-value"><?php echo e($report->location ?? ''); ?></div>
        </div>
      </div>
    </div>

    <div class="text-center">
    <a class="btn btn-sm btn-primary" href="<?php echo e(asset('storage/app/public/astrology_reports/' . $report->pdfName)); ?>" download>Download PDF</a>
  </div>
    ...
    <div class="footer">
      ...
      Report generated on <?php echo e(date('d-m-Y')); ?>
...
<?php echo $__env->make('frontend.layouts.member_panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PHP-Projects\lifematchings\httpdocs\resources\views/frontend/member/dashboard.blade.php ENDPATH**/ ?>