    ...
    <?php if(get_setting('show_homepage_slider') == 'on' && get_setting('home_slider_images') != null): ?>
        <section class="position-relative overflow-hidden min-vh-100 d-flex home-slider-area">
            ...
            <div class="absolute-full">
                <div class="aiz-carousel aiz-carousel-full h-100 d-none <?php echo e(get_setting('home_slider_images_small') != null ? 'd-md-block' : 'd-block'); ?>" data-fade='true' data-infinite='true' data-autoplay='true'>
    ...
    <div class="container text-center">
        ...
        <div class="pricing-scroller mt-5 pt-6 pb-6 s-padding">
            <?php $__currentLoopData = \App\Models\Package::where('active', '1')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                data-aos-delay="<?php echo e($loop->index * 200); ?>">
                    <div class="pricing-card">
                        <div class="pricing-header"><?php echo e($package->name); ?></div>
                        <div class="pricing-body vip">
                            <h2><?php echo e(single_price($package->price)); ?></h2>
                            <p>For <?php echo e($package->validity); ?> Days</p>
                            <?php if($package->id != 1): ?>
                                    <?php if(Auth::check()): ?>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-5 text-dark text-center">
                                        ...
                                        <span class="text-secondary d-block"><?php echo e($package->validity); ?>
                                            ...
                                            <?php echo e(translate('Months')); ?></span>
                                    </div>
...
<section class="pb-6 pricing-section">
  <div class="container text-center">
    ...
    <div class="pricing-scroller mt-5">
      <?php $__currentLoopData = \App\Models\Package::where('active', '1')->where('id', '!=', 1)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="pricing-item">
          <div class="pricing-card">
            <div class="pricing-header"><?php echo e($package->id == 1 ? translate('Free') : $package->name); ?></div>
            <div class="pricing-body 
              <?php echo e($loop->index % 4 == 0 ? 'gold' : ($loop->index % 4 == 1 ? 'diamond' : ($loop->index % 4 == 2 ? 'platinum' : 'vip'))); ?>">
              <h2><?php echo e(single_price($package->price)); ?></h2>
              <p>For <?php echo e($package->validity); ?> Days</p>
              <?php if($package->id != 1): ?>
                <?php if(Auth::check()): ?>
                  <a href="<?php echo e(route('package_payment_methods', encrypt($package->id))); ?>" class="btn btn-package">
                    Purchase This Package
                  </a>
                <?php else: ?>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PHP-Projects\lifematchings\httpdocs\resources\views/frontend/index.blade.php ENDPATH**/ ?>